...
Run from project root:
    python -m models.unet.diagnose_catastrophic_misses --run-dir models/checkpoints/unet_dualpol/<run_name>
"""
...
from models.unet.diagnose_underestimates import extract_radar_features, _valid_center
